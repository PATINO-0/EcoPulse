...
class _TripDetailScreenState extends ConsumerState<TripDetailScreen> {
  ...
  Future<_TripDetailData> _loadData() async {
  ...
  String _formatDateTimeIfTrusted(DateTime? value, {bool showTime = false}) {
    if (value == null) {
      return 'No disponible';
    }
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _HistoryHeader(
                      ...
                      subtitle:
                          'Consulta métricas, ruta, eficiencia y eventos detectados con una vista más clara y elegante.',
                      isDark: isDark,
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _TripHeroCard(
                      ...
                      subtitle:
                          'Una lectura clara del recorrido, su eficiencia y los eventos de conducción asociados.',
                      leftMetricLabel: 'Distancia',
                      leftMetricValue:
                          '${trip.distanceKm.toStringAsFixed(2)} km',
                      rightMetricLabel: 'Duración',
                      rightMetricValue: _formatDuration(trip.durationSeconds),
                    ),
                  ),
                ),
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _SectionTitleCard(
                      ...
                      subtitle:
                          'Indicadores principales del recorrido y su rendimiento estimado.',
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _InsightCard(
                      ...
                      content:
                          'Fuente del precio: ${trip.fuelPriceSource ?? 'No disponible'}\n'
                          'Dato marcado como oficial: ${trip.fuelPriceIsOfficial ? 'Sí' : 'No'}\n'
                          'Método de estimación: ${trip.estimationMethod}\n'
                          'Inicio: ${_formatDateTimeIfTrusted(trip.startedAt)}\n'
                          'Finalización: ${_formatDateTimeIfTrusted(trip.endedAt)}',
                    ),
                  ),
                ),
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _SectionTitleCard(
                      ...
                      subtitle:
                          'Mapa del recorrido con una superficie más limpia y consistente.',
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: _SectionTitleCard(
                      colors: colors,
                      title: 'Eventos de conducción',
                      subtitle:
                          'Registros relevantes detectados durante este trayecto.',
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 6),
              Text(
                'Estamos preparando el detalle del recorrido.',
